  ...
  return (
    <div className="container mx-auto px-4 py-16">
      <div className="max-w-4xl mx-auto">
        <h1 className="text-3xl font-bold mb-6 text-gradient">Help Center</h1>
            ...
            <div className="grid md:grid-cols-3 gap-4">
              <Card className="p-4 text-center hover:shadow-lg transition-shadow">
                ...
                <Button variant="outline" className="w-full" asChild>
                  <a href="tel:+251961343490">+251 961 343 490</a>
                </Button>
              </Card>
          ...
          <Card className="p-6">
            ...
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="item-2">
                ...
                <AccordionContent>
                  Visit your dashboard to see detailed analytics of your study progress, test scores, and areas for improvement.
                </AccordionContent>
              </AccordionItem>
