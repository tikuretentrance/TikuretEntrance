        ...
        <div className="container px-4 py-8 mx-auto mt-10">
            <div className="max-w-4xl mx-auto">
                    ...
                    <TabsContent value="general">
                        <Accordion type="single" collapsible className="space-y-4">
                            ...
                            <AccordionItem value="item-3" className="border rounded-lg px-6">
                                ...
                                <AccordionContent className="pb-4 pt-2 text-muted-foreground">
                                    To get started, simply create a free account by clicking the "Start Now" button. Once registered, you can access your dashboard, take practice tests, browse study materials, and track your progress.
                                </AccordionContent>
                            </AccordionItem>
                            ...
                            <AccordionItem value="item-4" className="border rounded-lg px-6">
                                ...
                                <AccordionContent className="pb-4 pt-2 text-muted-foreground">
                                    TikuretEntrance covers all subjects included in the Ethiopian University Entrance Examination, including Mathematics, Physics, Chemistry, Biology, English, Geography, History, Economics and Civics. We provide resources for both Natural Science and Social Science streams.
                                </AccordionContent>
                            </AccordionItem>
                    ...
                    <TabsContent value="exams">
                        <Accordion type="single" collapsible className="space-y-4">
                            ...
                            <AccordionItem value="item-2" className="border rounded-lg px-6">
                                ...
                                <AccordionContent className="pb-4 pt-2 text-muted-foreground">
                                    Practice exams are automatically scored upon completion. You'll receive an overall score, as well as a breakdown by subject and topic. 
                                    {/* For premium users, we also provide detailed performance analytics, comparing your results to other students and tracking your progress over time. */}
                                </AccordionContent>
                            </AccordionItem>
                            ...
                            <AccordionItem value="item-4" className="border rounded-lg px-6">
                                ...
                                <AccordionContent className="pb-4 pt-2 text-muted-foreground">
                                    We currently offer over 50-120 full-length practice exams across all subjects and streams. This includes exams from previous years (2015-2024) and custom-created practice tests that target specific topics and difficulty levels.
                                </AccordionContent>
                            </AccordionItem>
                    ...
                    <TabsContent value="account">
                        <Accordion type="single" collapsible className="space-y-4">
                            <AccordionItem value="item-1" className="border rounded-lg px-6">
                                ...
                                <AccordionContent className="pb-4 pt-2 text-muted-foreground">
                                    To create an account, click the "Start Now" button in the top right corner of the homepage. You'll need to provide your email address, create a password, and fill in some basic information about your educational background or simply by clicking Continue with Google. The registration process takes less than 2 minutes.
                                </AccordionContent>
                            </AccordionItem>
                            ...
                            <AccordionItem value="item-5" className="border rounded-lg px-6">
                                ...
                                <AccordionContent className="pb-4 pt-2 text-muted-foreground">
                                    You can contact our customer support team through the "Contact Us" page, by emailing support@tikuretentrance.com. Our support team is available Monday through Saturday, 9 AM to 6 PM EAT.
                                </AccordionContent>
                            </AccordionItem>
                        </Accordion>
                    </TabsContent>
                ...
                <Card className="mb-12">
                    ...
                    <CardContent>
                        <Button className="w-full sm:w-auto" onClick={() => window.location.href = 'mailto:support@tikuretentrance.com'}>Contact Support</Button>
                    </CardContent>
                </Card>
            </div>
        </div>
